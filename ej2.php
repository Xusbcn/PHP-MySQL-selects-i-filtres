...
<body>
	<?php
		...
		$conn = mysqli_connect('localhost','xus','xus123');
 		...
 		$consulta = "SELECT city.Name CINAME,country.Name CONAME FROM city,country WHERE city.CountryCode=country.Code AND city.CountryCode='$VARIABLE';";
	...
	<!-- (3.1) aquí va la taula HTML que omplirem amb dades de la BBDD -->
 	...
 	<?php
 		...
 		while( $registre = mysqli_fetch_assoc($resultat) )
 		{
 			...
 			#	i tancar amb un </td>
 			echo "\t\t<td>".$registre["CINAME"]."</td>\n";
 			echo "\t\t<td>".$registre['CONAME']."</td>\n";
